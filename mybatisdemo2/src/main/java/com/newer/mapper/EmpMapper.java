...
public interface EmpMapper {
    @Insert("insert into emp values(#{empno},#{ename},#{sal},#{hiredate},#{dept.deptno},#{job})")
    int addEmp(Emp emp);
    @Update("update emp set ename=#{ename},sal=#{sal},hiredate=#{hiredate},deptno=#{dept.deptno},job=#{job} where empno=#{empno}")
